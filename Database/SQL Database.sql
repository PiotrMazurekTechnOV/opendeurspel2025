...
CREATE TABLE `locations` (
  ...
  UNIQUE KEY `Lokaal Nummer_UNIQUE` (`number`),
  UNIQUE KEY `Richting Naam_UNIQUE` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scores` (
  ...
  UNIQUE KEY `questions_id_UNIQUE` (`question_id`),
  CONSTRAINT `question_id` FOREIGN KEY (`id`) REFERENCES `questions` (`id`),
...
CREATE TABLE `users` (
  ...
  `gsm_number` int NOT NULL,
  `code` int NOT NULL,
  `consent` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
